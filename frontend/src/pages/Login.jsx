    ...
    return (
        <div className="min-h-screen flex w-full">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-black">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-tr from-green-900/60 to-transparent flex flex-col justify-between p-12">
                    <div>
            ...
            {/* Right Side - Form */}
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white md:px-12">
